...
public class Color {
  ...
  private final int redValue; // The red component of an RGB colour
  private final int greenValue; // The green component of an RGB colour
  private final int blueValue; // The blue component of an RGB colour
